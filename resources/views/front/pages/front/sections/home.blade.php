<section id="home" class="home d-flex align-items-center">
    <div class="container">
        ...
        <div class="intro">
            ...
            <span>@lang('global.i_am') <span class="text-rotating">@foreach ($habilities as $key => $item) @lang($item) @if(count($habilities)-1 != $key) , @endif @endforeach</span></span>
            ...
            <!-- buttons -->
            <div class="mt-4">
                <a href="#contact" class="btn btn-default">@lang('global.contact_form.title')</a>
            </div>
        </div>
        ...
        <div class="scroll-down">
            <a href="#about" class="mouse-wrapper">
                <span>@lang('global.scroll_down')</span>
                <span class="mouse">
