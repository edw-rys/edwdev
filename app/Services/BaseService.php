...
class BaseService
{
    ...
    public function processImage(UploadedFile $image_upload, $folder = ''): string
    {
        ...
        // Image paths
        $thumbnail      = public_path() . '/' . config('app_buro.common.thumbnail_path');
        $image          = public_path() . '/' . config('app_buro.common.cover_path');
        ...
        return config('app_buro.common.thumbnail_path') . '/' . $imageName;
    }
