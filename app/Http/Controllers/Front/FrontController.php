...
class FrontController extends Controller
{
    ...
    {
        Mail::to(config('app_project.emails.send'))->send( new ContactMail($request->input('message'), $request->input('subject'), $request->input('name'), $request->input('email'), $request->input('identification_number')));
